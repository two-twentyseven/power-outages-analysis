...
**Test Statistic:** The observed difference in medians (median A − median B), compared to a null distribution generated by shuffling region labels within each pair.

Our methodology:
<br>

1) For calculating the median, we want to avoid "Zero-minute outages" since they are likely errors upon data-insertion.
<br>
